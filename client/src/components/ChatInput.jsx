...
const ChatInput = ({
  ...
  <>
    {(chatState === 'chatting' || chatState === 'disconnected') && (
      ...
      >
        <div className="flex items-center w-full border border-[#ece5dd] rounded-full bg-white dark:bg-gray-700 px-3 py-3 shadow-sm">
          <button
            type="button"
          ...
          <input
            ...
            className="flex-1 px-3 py-5 bg-transparent outline-none"
