...
const ChatBox = () => {
  ...
  return (
    <div className="w-full flex justify-center bg-[#ece5dd] dark:bg-gray-900 transition-colors duration-300 h-[100dvh] overflow-hidden">
      <div className="w-full h-full flex flex-col pb-safe pb-6">
        <div className="
          flex flex-col
          w-full h-full
        ...
        ">
          ...
          >
            <div className="flex-1 overflow-y-auto px-2 pt-[40px] pb-4 no-scrollbar" ref={listContainerRef}>
            ...
            {/* Input + Footer */}
            <div className={`shrink-0 transition-all duration-300 ${keyboardVisible ? 'pb-[env(safe-area-inset-bottom)]' : 'pb-6'}`}>
              <ChatInput
                input={input}
